...
const UpdateModal = ({ show, handleClose, onUpdate, orchidData }) => {
    ...
    const validationSchema = Yup.object().shape({
        ...
        color: Yup.string()
            ...
            .max(20, 'Color must be at most 15 characters.')
    ...
    const formik = useFormik({
        initialValues: {
            ...
            rating: orchidData?.rating || 0,
            isSpecial: orchidData?.isSpecial || false,
            image: orchidData?.image || '',
            color: orchidData?.color || '',
            origin: orchidData?.origin || '',
            category: orchidData?.category || '',
            description: orchidData?.description || '',
        },
        validationSchema,
        enableReinitialize: true,
        onSubmit: (values) => {
            onUpdate(orchidData.id, values);
            handleClose();
        },
    });
    ...
    return (
        <Modal size="lg" show={show} onHide={handleClose} centered>
            <Modal.Header closeButton>
                <Modal.Title>Update Orchid</Modal.Title>
            </Modal.Header>
            <Modal.Body>
